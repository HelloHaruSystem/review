...
public class InstanceVariablerInput
{
    // bool InstancevariablerMenuChoice() til at få bruger input ligesom vi gjorde i hovedmenuen
    public static bool InstancevariablerMenuChoice()
    {
        ...
        while (!validInput)
        {
            ...
            switch (userInput)
            {
                case "1":
                    validInput = true;
                    InstanceVariablerExercises.Opg1();
                    break;
                case "x":
                    return false;
                default:
