...
public class KonstruktorsInput
{
    // bool KonstruktorsMenuChoice() til at få bruger input ligesom vi gjorde i hovedmenuen
    public static bool KonstruktorsMenuChoice()
    {
