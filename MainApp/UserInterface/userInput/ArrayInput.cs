...
{
    // ArraysMenuChoice() til at få bruger input ligesom vi gjorde i hovedmenuen
    public static bool ArraysMenuChoice()
    {
        ...
        while (!validInput)
        {
            ...
            switch (userInput)
            {
                case "1":
                    validInput = true;
                    ArraysExercises.Opg1();
                    break;
                case "2":
                    validInput = true;
                    ArraysExercises.Opg2();
                    break;
                case "3":
                    validInput = true;
                    ArraysExercises.Opg3();
                    break;
                case "x":
                    return false;
                default:
